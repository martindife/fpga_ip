...
proc init_gui { IPINST } {
  ...
  #Adding Group
  ipgui::add_group $IPINST -name "Processor Options" -parent ${Memory_Configuration}
  ...
  #Adding Group
  set IN_Port_Configuration [ipgui::add_group $IPINST -name "IN Port Configuration" -parent ${Process}]
  ipgui::add_param $IPINST -name "IN_PORT_QTY" -parent ${IN_Port_Configuration}

  #Adding Group
  set Peripherals [ipgui::add_group $IPINST -name "Peripherals" -parent ${Process}]
  ...
  #Adding Group
  ipgui::add_group $IPINST -name "Options" -parent ${Page_0}
